# Stage 06: Submitted & Tracking

> This folder holds projects where proposals have been submitted. Track outcomes, follow up, learn from results, and steward relationships.

---

## This Is a Human-Driven Stage

Claude Code supports this stage but doesn't drive it. Humans submit proposals and track outcomes.

## For Humans (Josh / Alycia / Valerio)
...
Every quarter, review all projects in 06-submitted/:
...
If asked to help with this stage:
- Summarize the current state of all submissions across projects
- Draft follow-up emails based on submission logs
