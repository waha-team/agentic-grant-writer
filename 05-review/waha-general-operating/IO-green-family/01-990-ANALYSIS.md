# 990 Analysis: Green Family Foundation Inc

*Source: ProPublica Nonprofit Explorer (EIN 27-5341883), Grantable.co, public reporting*
*990s reviewed: Available filings through 2021 (most recent confirmed on ProPublica); later years may be available*
...
*Full grantee list requires 990-PF download from:* https://projects.propublica.org/nonprofits/organizations/275341883
...
- **What types of work do they actually fund?**
  - Bible technology and digital Scripture access (~priority 1 based on YouVersion relationship)
  - Scripture distribution (OneHope, Every Home for Christ)
  - Christian higher education and ministerial training (Highlands College)
  - Evangelical missions infrastructure
  - Church planting and multiplication (Highlands College graduates plant churches)
- **Any surprising grants?** The $20M to Highlands College is a massive bet on institutional church leadership development — suggests the family is willing to make infrastructure investments, not just project grants.

## Similar Organizations Funded
- **YouVersion (Life.Church)** — Bible app with 500M+ installs; Waha's DMC is available on YouVersion; Jenny Tangeman (CSO) endorses Waha. This is the closest analog and the warm path.
  - "Mart Green offered help to YouVersion founder Bobby Gruenewald before the project launched as a website back in 2007."
  - If the Green family considers YouVersion a portfolio success, Waha is the disciple-making activation layer on top of YouVersion's Bible access.
- **OneHope** — Scripture for children globally; similar digital access model

## Recommended Ask Amount
- **First exploratory step:** No dollar ask. Request a meeting through the YouVersion connection.
- **Eventual first ask (if invited):** $25,000 – $100,000 — sized modestly to establish the relationship, not to win a flagship grant.
- **Long-term relationship potential:** $100,000 – $500,000+ if Waha demonstrates impact at scale.
...
*The Grants Officer (Brittany Green Daniels) is the correct first contact for any formal grant inquiry, once introduced through the network.*
