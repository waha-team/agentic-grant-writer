# Key People: The Huston Foundation
...
- **Notes for engagement:** Nancy is THE person Waha must meet. She is warm, relationship-oriented (this is why the meeting is required), and has spent her career funding evangelical missions and discipleship. She will respond to: authentic Great Commission passion, multiplication (not just addition), evidence that Waha is making real disciples in hard-to-reach places, and financial credibility. She will probe whether this is a genuine ministry with genuine fruit vs. a technology product looking for Christian funding. The Biblica connection (Biblica is a Huston grantee AND a Waha partner) is a potential warm path to Nancy.
- **Recommended contact:** Call 610-832-4955 ext. 4. Reference that you learned about the Foundation's evangelical grants and are seeking to schedule the required introductory meeting per the Foundation's process. Mention Biblica as a shared connection if possible.
...
### Scott G. Huston — Treasurer; Community Relations Program Director
- **Background:** Son of Charles Lukens Huston, Jr. (or nephew — exact relationship unclear from available records; confirmed Huston family member). Based in Berwyn, PA. Oversees Community Relations grantmaking alongside (the late) Charles L. Huston III. No LinkedIn found.
- **Notes for engagement:** Not the primary contact for evangelical grants.
...
### Christianna S.J. DeWind — Director
- **Background:** Based in Del Mar, CA (previously Carbondale, CO). Huston family member. No public professional profile found. No LinkedIn found.
- **Notes for engagement:** No specific engagement strategy identified.

---

### Robert S. Huston — Director
- **Background:** Based in Phoenixville, PA. Huston family member. No public professional profile found.
- **Notes for engagement:** No specific engagement strategy identified.
...
### Chloe Campbell (mentioned on website, no 990 listing)
- **Title:** Current grantees contact (mentioned on the website: "Current grantees funded within 2 years should contact Chloe Campbell")
- **Notes:** Not relevant for Waha as a new applicant, but note the name for future cycles.

---

## Warm Paths

- [ ] **Biblica is both a Huston grantee ($25,000 in 2023) and a Waha partner** — Alan White (Senior Director of Partnerships at Biblica) endorses Waha. This is the strongest potential warm path. If Alan White or anyone at Biblica knows Nancy Hansen personally, a referral or introduction from Biblica could meaningfully warm this cold approach.
- [ ] **Check Jeff Peterson / Waha team:** Does anyone on the Waha team have connections in the Philadelphia evangelical community (Chester County, Wayne, PA area)? Nancy Hansen's ministry network is thick in this geography.
- [ ] **Capstone Legacy Foundation:** Nancy Hansen's own organization. If Waha were ever connected to Capstone's network, that would be a direct warm path — but this is speculative.
- [ ] **Inner-City Movement** received a Huston grant for "Family Devotions with ActorsBible" — audio Bible engagement. This is conceptually close to Waha. If there is any connection to Inner-City Movement leadership, it could serve as a reference.
- [ ] **Attio CRM check:** No "Huston" entity or "Nancy Hansen" found in Waha's CRM. No direct connection identified.
- **Current assessment:** No warm path identified. Cold outreach by phone is the required first step — calling the evangelical line to arrange the mandatory Nancy Hansen meeting.

---

## Recommended Salutation (for LOI and proposal)

"Dear Nancy, Elinor, Scott, Rebecca, and the Huston Foundation Board of Directors,"

Or, if writing specifically to Nancy after a meeting:
"Dear Nancy,"
...
**DIRECT APPLICATION** — but meeting with Nancy Hansen is required first.

**Recommended first action (URGENT):**
1. Call 610-832-4955 ext. 4 and ask to schedule an introductory meeting with Nancy Huston Hansen. Reference that Waha is a new applicant seeking to follow the Foundation's stated process for new evangelical organizations.
2. Prepare a 1-page "ministry overview" for the meeting — not a formal proposal, but a clear, warm description of who Waha is, what they do, and why it aligns with the Foundation's mission.
3. **Before the meeting**, check whether Biblica's Alan White can make an introduction or even send a brief note to Nancy Hansen.
4. After the meeting, submit LOI via the online portal (www.grantinterface.com) if Nancy gives a green light.

**Timeline for spring 2026 cycle:**
- Now — March 15: Arrange and complete Nancy Hansen meeting
- March 15–20: Submit LOI online
- April 1: LOI deadline
- Mid-May: Board makes funding decisions
- If meeting cannot happen by March 15: Target fall cycle (LOI by October 1, decisions in November)
