# Application Requirements: The Huston Foundation

*Researched: 2026-03-03*
*Sources: hustonfoundation.org — grant_process.cfm, requirements.cfm, faq.cfm, apply.cfm*
...
The foundation reviews LOIs before inviting full applications. The LOI must be submitted through the online portal at grantinterface.com.

**What the LOI should accomplish:**
- Demonstrate Waha's Protestant Evangelical Christian identity and theology
- Show active Gospel presentation with opportunities to receive Christ as personal savior
- Describe the specific project or program being funded
- Indicate the amount being requested
- Establish Waha's organizational credibility

**LOI content requirements (inferred from website):**
- Organization overview and history
- Statement describing the project/program
- Evidence of Gospel presentation in the work
- Amount requested
- Contact information

**Note:** Specific LOI word limits or question format is not publicly listed on the website. The portal may contain specific fields. This should be asked during the Nancy Hansen meeting.

---

## Step 2: Full Application (by invitation only, after LOI approval)

### Required Documents (from faq.cfm)
...
> In the Holy Spirit as a person who proceeds from the Father and the Son, by whom every believer is regenerated, in dwelt, empowered and sealed into the body of Christ which he believes;
> In the Holy Scriptures as inspired by the Holy Spirit of God."

Waha must be able to genuinely affirm this statement — and it should be formally adopted and signed by Waha's principal officer.
...
- Endowment funds
- Tickets for events or advertising
- Fraternal organizations
- Political candidates or parties
- Political Action Committees
- Veterans organizations, labor groups, social clubs
- Coverage of continuing operating deficits
- Document publication costs
- Capital building / construction
- Multi-year grant funding — **NOTE: Each application must be for a single year**
...
## Key Framing (from 03-VOCABULARY-AND-FRAMING.md)

- **Lead with:** Great Commission mandate + evangelism and discipleship gap
- **Frame the ask under:** Protestant Evangelical Media-Communication (distribution, translation, publishing) + Discipleship (developing nations, missionary support)
- **Must include:** Active Gospel presentation with "opportunities to receive Christ as their personal savior" — this is explicitly required
- **Strongest comp to reference:** Biblica ($25,000 for Reach4Life) — Waha partners with Biblica directly
- **Doctrinal language:** Use their exact terms — "personal evangelism," "spreading the Gospel of Jesus Christ," "Christ-centered," "Biblical claims of Christ," "developing nations," "missionary"
...
|---|---|---|
| Call Nancy Hansen to arrange introductory meeting | Josh | IMMEDIATELY — by March 10 at latest |
| Complete introductory meeting with Nancy Hansen | Josh | By March 18 |
| Prepare signed Statement of Faith (affirm Huston doctrinal statement) | Josh | Before LOI submission |
| Prepare signed principal statement (no changes since IRS letter) | Josh | Before full application |
| Verify PA Bureau of Charitable Organizations registration status | Josh | Before full application |
| Confirm Waha can affirm the Huston doctrinal statement | Josh | Before anything |

---

## If Spring 2026 Deadline Cannot Be Met

If the Nancy Hansen meeting cannot be arranged before March 18 or so, the spring cycle deadline of April 1 will not be achievable. In that case:
- Complete the meeting whenever possible (even after April 1)
- Target the fall 2026 cycle: opens July 14, deadline October 1
- This gives more time to prepare a stronger application and deepen the relationship
