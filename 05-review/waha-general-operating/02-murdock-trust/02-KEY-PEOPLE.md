# Key People: M.J. Murdock Charitable Trust
...
- **Background:** Leads all grant programs. Also serves as sector lead for Education & Leadership Development. Key decision-maker for all grantmaking strategy.
- **Notes for engagement:** Fong oversees the program team. For a faith-based organization like Waha, the proposal would flow through Civic Engagement but Fong has cross-sector visibility.
...
### Jeremy White, Senior Program Officer — Civic Engagement & Community Services
- **Background:** Senior program officer under Carrasco. Processes LOIs and manages grantee relationships in the sector.
- **Notes for engagement:** Likely the first staff reviewer of Waha's LOI. Should be acknowledged in correspondence.

### Jennifer Groth, Senior Program Officer — Civic Engagement & Community Services
- **Background:** New hire in 2023. Also covers the sector alongside White.
- **Notes for engagement:** May be assigned to faith-based or international-scope grants given her new role.

### Marybeth Stewart Goon, Senior Grants Manager
- **Background:** 15+ years at Murdock (retired as Senior Program Director before potentially returning or being listed in another capacity). Long institutional knowledge. Manages grants administration.
- **Notes for engagement:** For administrative questions about the portal and process.

---

## Warm Paths

- [ ] Check if any Waha team/board members know Rudy Carrasco (VP, Civic Engagement)
- [ ] Check for shared networks: Pacific Northwest evangelical community, Spokane nonprofit networks
- [ ] **Lighthouse Mission Ministries** (Bellingham, WA) received a $1M Murdock grant in 2023 — if Waha has any connection to LMM, an introduction could be valuable
- [ ] **International Deaf Education Association** (Montana) received a $244K grant — faith-based international mission org. Waha has ASL content (Emily Amberg, Regional Coordinator for the Deaf) — potential connection
- [ ] Check if Antioch Community Church (Waha partner) has any PNW campus or relationship with Murdock-funded organizations
- [ ] **Richard Stearns** is listed as a Murdock Senior Fellow — he is the former president of World Vision and deeply embedded in the evangelical missions world. If Waha has a connection through 24:14, Pioneers, or Wycliffe, Stearns could be a warm path.
- **Identified connections:** None confirmed — recommend cold LOI submission via Submittable portal, but investigate Richard Stearns / Murdock Senior Fellow connection through Waha's missions network.

---

## Recommended Salutation

**For LOI:** Since LOIs are submitted through the Submittable portal (not directly to staff), the application format likely doesn't use a personal salutation. However, if a cover note is included:

"Dear Rudy, Jeremy, Jennifer, and the Civic Engagement review team,"

**For any follow-up correspondence or cover letter:**
"Dear Rudy Carrasco and the Murdock Civic Engagement team,"

---

## Recommended Contact Strategy

**DIRECT APPLICATION via Submittable portal** — no warm introduction required or available at this time.

**Recommended first action:**
1. Complete Murdock's online eligibility quiz at murdocktrust.org/grant-application-process/
2. If eligible, submit LOI as soon as Period 2 LOI window opens (approximately April 2026)
3. Before submitting LOI, attempt to identify any connection to Rudy Carrasco through Waha's PNW network or through Richard Stearns (Murdock Senior Fellow)
4. Do NOT hire the targeted staff member (Head of Marketing or Head of Product) before a site visit — Murdock explicitly disqualifies staff hired before the site visit

**Relationship strategy:** If LOI is declined, wait one year and reapply with refined framing. If LOI advances, prepare for program officer outreach and potential site visit.
