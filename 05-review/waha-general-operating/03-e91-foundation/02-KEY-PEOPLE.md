...
### Primary Contact: mail@e91foundation.org
The foundation does not list a named grants contact beyond the leadership above. All initial contact should go to mail@e91foundation.org.
...
- [ ] **Cru connection:** E91 funded Cru in Q1 and Q3 2024 ($5,000 each). Waha lists Cru as a partner. If Waha has a specific Cru contact who knows the Indianapolis area or who knows E91 directly, this could be a warm introduction. [JOSH: Do you have a Cru contact who could introduce Waha to E91?]
- [ ] Check if any Waha team members have connection to Indianapolis evangelical community or East 91st Street Christian Church
- [ ] Crescent Project received $5,000 from E91 in Q1 2025 — if Waha has any connection to Crescent Project, an introduction could help
- **Identified connections:** None confirmed. Recommend cold LOI submission via mail@e91foundation.org.

---

## Recommended Salutation

"Dear Blair, Beth, Adrian, and the E91 Foundation board,"

---

## Recommended Contact Strategy

**COLD LOI SUBMISSION** — no invitation required. E91's process is explicitly open: "A brief introduction requiring less detail than a full proposal. No invitation needed to submit."

**Recommended first action:**
1. Write LOI (draft is in 07-LOI-DRAFT.md)
2. Send to mail@e91foundation.org
3. Wait for response — if invited to submit full proposal, complete 05-PROPOSAL-DRAFT.md content

**Tone:** Warm, evangelical-insider, story-first. Unlike Murdock (which requires more institutional language), E91 is a faith community that speaks Waha's native language. Use "Great Commission," "disciple-making," "unreached people groups," "evangelism" freely. These are not jargon to this audience — they are values.

**No pre-submission meetings:** FAQ states "pre-submission meetings generally aren't held until after a proposal invitation." Don't request a call before submitting the LOI.
