# Briefing: Engage Global — General Operating Support

*Adapted from existing research at:*
`/home/yeshu/projects/grants/03-application-prep/castilian-spanish-localization/02-engage-global/`
...
The original Castilian Spanish proposal asked for $25,000 for a single language project. For general operating support, the framing shifts to:

**Waha as the mobilization tool that extends what Engage Global trains churches to do.**

Engage Global's entire mission is mobilizing churches to engage unreached peoples through the five habits (pray, send, welcome, mobilize, go). Waha supports ALL FIVE habits:
- **Pray** — DBS groups pray for unreached peoples as they engage Scripture
- **Send** — Waha equips those who are sent with free disciple-making tools
- **Welcome** — Waha available in diaspora languages for local outreach to internationals
...
No formal grant portal. Relationship-based application:
1. Email introduction to Tom Jensen (info@engageglobal.org)
2. Attach 1-page concept note + brief budget
3. Ask for their preferred process for partner grant requests
4. Follow up by phone (612-770-5998)

## CRM Note

Engage Global is NOT in the Attio CRM. Tom Jensen, Rick Davis, and Sandra Jensen are not in the CRM. However, Pioneers IS in the CRM (record ID: ec42aa02-5c34-4459-ab77-b5fc79a9e2f3). Engage Global funds Pioneers — this shared relationship is the warmest available connection point.

## Alignment Assessment

| Criteria | Score | Notes |
|----------|-------|-------|
| Mission alignment | STRONG | Both focused on unreached peoples; Great Commission |
| Faith-based willingness | PASS | Explicitly Christian organization |
| Geographic fit | STRONG | Global reach, emphasis on least-reached peoples |
| Grant type/size | MODERATE | They can fund $25K; but only fund 2 orgs currently |
| Strategic value | HIGH | Their church network could become Waha user base |

**Overall: Strong candidate. Worth pursuing directly. No major blockers beyond relationship-building.**
